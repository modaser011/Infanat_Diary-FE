...
const AllDoctors = () => {
  return (
    ...
    //         <Container id={d.cont} className="justify-content-center align-content-center justify-content-center me-5 justify-content-center align-item-center text-center d-flex">

    // <Row className='d-flex container mx-auto bg-dark  mx-sm-auto'>

    //     <Col lg={true} className='col-10 mt-5'>
