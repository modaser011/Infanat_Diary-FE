...
const RegisterDoctor = () => {
  ...
  const validate = (e) => {
    e.preventDefault();
    setErrors(DoctorValidate(vals,verficationImage));
    let xc = DoctorValidate(vals,verficationImage);
    ...
    if (xc.name === "" && xc.password === "" && xc.confirmpassword === ""&&xc.verficationImage==="") {
      ...
      axios
        .post("https://infant-diary-backend.onrender.com/api/v1/doctor/signup", formData, {
