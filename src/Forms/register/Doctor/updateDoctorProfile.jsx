...
import DoctroUpdateValidate from "./DoctorUpdatevalidate";
export function UpdateDoctorProfile() {
  ...
  const validate = (e) => {
    e.preventDefault();
    setErrors(DoctroUpdateValidate(vals));
    let xc = DoctroUpdateValidate(vals);
    if (vals.password === "" && vals.confirmpassword === "") {
      if (xc.name === "") {
        ...
        axios
          .put(
            "https://infant-diary-backend.onrender.com/api/v1/doctor",json,
            {
              headers: {
    ...
    if (vals.password !== "" || vals.confirmpassword !== "") {
      if (xc.name === "" && xc.password === "" && xc.confirmpassword === "") {
        ...
        axios
          .put(
            "https://infant-diary-backend.onrender.com/api/v1/doctor",
            json,
            {
            ...
            <Form className="text-center mx-3 " onSubmit={validate}>
              ...
              <Form.Group id={d.coll2}>
                <Form.Control
                  ...
                  x="true"
                />
                <Form.Label id={d.label2}>Age</Form.Label>
              </Form.Group>
