...
tkn.details.services.length === 0 && !tkn.loudingHospValues &&(
    ...
    <Alert variant="warning">There is no Services</Alert>
    <p> You can add new service from This page</p>
    <Link to="/hospitalservicesDetails">All Services</Link>
  </p>
        ))}
