...
const DocSuspend = () => {
    ...
    useEffect(() => {
      ...
      const unsuspendDoctor = async (id1) => {
        await axios
          .put(
      ...
      <Container >
        ...
        <div style={{ overflow: "scroll" }}>
          <div>
              ...
              {data1.doctorBlk.length === 0 && !data1.loudDoctorBlk &&(
          <p className="align-self-center">
             <Alert variant='warning'>There is no suspended Doctors</Alert>  
          </p>
        )}
              {data1.doctorBlk.length === 0 && data1.loudDoctorBlk && (
...
{data1.doctorBlk.length >= 1 ? (<Table 
          responsive="xs"
     ...
     {data1.doctorBlk.length >= 1 ? (
                data1.doctorBlk.map(({ email, role, name, _id }) => (
            <tr>
              <td >
              ...
              >
                <Button variant="primary" className=" mt-2 mx-3" style={{color:'white'}} onClick={()=>unsuspendDoctor(_id)}
>
                <img
                    src={suspend}
                    alt=""
                ...
                <Button variant="danger" className=" mt-2 mx-3" onClick={()=>data1.deletion('doctor',_id)}>
                <img
                    src={delete1}
                    alt=""
                   className='me-2'
