...
import DeleteConf from '../../../DeleteConfirmation';
const ParentUser = () => {
      ...
      <Container >
        ...
        <div style={{ overflow: "scroll" }}>
          <div>
              ...
              {data1.parent.length === 0 && !data1.loudParent &&(
          <p className="align-self-center">
             <Alert variant='warning'>There is no parents users</Alert>  
          </p>
        )}
              {data1.parent.length === 0 && data1.loudParent && (
...
{data1.parent.length >= 1 ? (<Table 
     ...
     {data1.parent.length >= 1 ? (
                data1.parent.map(({ email, role, name, _id }) => (
            <tr>
              <td >
              ...
              >
                <Button variant="primary" className=" mt-2 mx-3" style={{color:'white'}} onClick={()=>suspendParent(_id)}
>
                <img
                    src={suspend}
                    alt=""
